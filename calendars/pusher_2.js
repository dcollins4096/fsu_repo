...
changeset:   1:aeb79e15b0fd
tag:         tip
user:        dcollins4096
date:        Fri Jun 01 16:50:37 2018 -0400
summary:     tweaks for robustness
*/
//
//
// Notes:  
...
var event = function(this_line,head_line,metaData,sheetPackage){
  ...
  this.getStartTime = function(){
    ...
    var thisStatus = sheetPackage.getBoxByID( sheetPackage.currentLine, 'Status');
    thisStatus.setValue(HoursMinutes); thisStatus.setBackground('red');
...
function CalendarPusher() {
  ...
  for (var i=0;i< lastRow - headLineNumber; i++){ 
    ...
    //KLUDGE
    thisEvent.getStartTime();
    //thisTestBox.setValue(thisEvent.getStartTime());
    continue;
    //KLUDGE
